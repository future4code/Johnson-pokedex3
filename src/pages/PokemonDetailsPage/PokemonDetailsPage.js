...
import { PokemonDetailsContainer, PokemonDetailsBackground, PokemonDetailsCard } from './styles';
                    ...
                    <div className="all">
                        ...
                        <div className="infos__types">
                            <div className="name__number">
                                {name && <h1 style={{color: '#212121'}}>{name.toUpperCase()}</h1>}
                                {pokemon.id && <h1 style={{color: 'gray'}}>Nº {pokemon.id}</h1>}
                            </div>
                            <div className="infos">
                                <div className="info_1">
                                    <span style={{color: '#fff'}}>Height:</span>
                                    <span style={{color: '#212121'}}><b>{height / 10} m</b></span>                                        <span style={{color: '#fff'}}>Weight:</span>
                                    <span style={{color: '#212121'}}><b>{weight / 10} kg</b></span>
                                    <span style={{color: '#fff'}}>Abilities:</span>
                                    {abilities && <span style={{color: '#212121'}}><b>{abilities[0].ability.name}</b></span>}
                                </div>
                                <div className="info_2">
                                    <span style={{color: '#fff'}}>HP:</span>
                                    {stats && <span style={{color: '#212121'}}><b>{stats[0].base_stat}</b></span>}
                                    <span style={{color: '#fff'}}>Attack:</span>
                                    {stats && <span style={{color: '#212121'}}><b>{stats[1].base_stat}</b></span>}
                                    <span style={{color: '#fff'}}>Defense:</span>
                                    {stats && <span style={{color: '#212121'}}><b>{stats[2].base_stat}</b></span>}
                                </div>
                                <div className="info_3">
                                    <span style={{color: '#fff'}}>Special Attack:</span>
                                    {stats && <span style={{color: '#212121'}}><b>{stats[3].base_stat}</b></span>}
                                    <span style={{color: '#fff'}}>Special Defense:</span>
                                    {stats && <span style={{color: '#212121'}}><b>{stats[4].base_stat}</b></span>}
                                    <span style={{color: '#fff'}}>Speed:</span>
                                    {stats && <span style={{color: '#212121'}}><b>{stats[5].base_stat}</b></span>}
                                </div>
                            </div>
                            <div className="types">
